...
@section('title', 'Admin | POS All Orders')
    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">All POS Pending Order</h3>
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" id="printableArea{{ $order->id }}">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p><strong>Amount:</strong> {{ $order->amount ?? 'N/A' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        @if ($order->status === 'pending')
                                                            <form action="{{ route('admin.orders.pos-complete', $order->id) }}"
                                                                method="POST">
                                                                @csrf
